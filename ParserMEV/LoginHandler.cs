...
{
    public async Task Login(Cookie cookie)
    {
        ...
        var content = new FormUrlEncodedContent(new[]
        {
            ...
            new KeyValuePair<string, string>("DeptoRegistrado", "aa")
        });
    ...
    public async Task<HtmlDocument> GetSearchDocumentForDeptoJudicial(Cookie cookie, string DJ)
    {
        var handler = new HttpClientHandler
        {
            UseCookies = true,
        ...
        var httpClient = new HttpClient(handler);
        httpClient.DefaultRequestHeaders.Add("User-Agent", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/110.0.0.0 Safari/537.36");
        httpClient.DefaultRequestHeaders.Add("Referer", "https://mev.scba.gov.ar/POSLoguin.asp");
        httpClient.DefaultRequestHeaders.Add("Accept-Encoding", "gzip, deflate, br");
        httpClient.DefaultRequestHeaders.Add("Accept-Language", "en-US,en;q=0.9,es;q=0.8");
        httpClient.DefaultRequestHeaders.Add("Upgrade-Insecure-Requests", "1");
        ...
        var content = new FormUrlEncodedContent(new[]
        {
            ...
            new KeyValuePair<string, string>("DtoJudElegido",DJ),
            new KeyValuePair<string, string>("Aceptar", "Aceptar")
        });
        var response = await httpClient.PostAsync("https://mev.scba.gov.ar/POSLoguin.asp", content);
        response.EnsureSuccessStatusCode();
